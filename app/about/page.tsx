...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-3xl font-bold mb-6">About Groq PDF Assistant</h1>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Groq PDF Assistant is a powerful tool that allows you to interact with PDF documents using artificial intelligence. 
            Whether you need to quickly find information in a document or generate concise summaries, this app provides 
            an intuitive interface powered by Groq&apos;s Llama 3 model.
          </p>
        </CardContent>
      </Card>
